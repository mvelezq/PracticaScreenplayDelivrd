...
public static final Target AGREED_TERMS_INPUT = Target.the("Aceptar terminos").locatedBy("//input[@id='UserTos']");
public static final Target CONFIRM_BUTTON = Target.the("Boton de confirmar").locatedBy("//button[@id='signup']");
